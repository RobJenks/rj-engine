...
Result TexcubeShader::Initialise(ID3D11Device* device, HWND hwnd)
{
	...
	Result result = InitialiseShader(device, hwnd,	iShader::ShaderFilename("texcube_sm_all.vs").c_str(),
													iShader::ShaderFilename("texcube_sm_all.ps").c_str());
...
Result TexcubeShader::Render(ID3D11DeviceContext* deviceContext, int indexCount, D3DXMATRIX worldMatrix, 
...
Result TexcubeShader::InitialiseShader(ID3D11Device* device, HWND hwnd, const char* vsFilename, const char* psFilename)
{
	HRESULT result;
	...
	result = D3DX11CompileFromFile(vsFilename, NULL, NULL, "TexcubeVertexShader", m_locale->Locale.VertexShaderLevelDesc, 
	...
	result = D3DX11CompileFromFile(psFilename, NULL, NULL, "TexcubePixelShader", m_locale->Locale.PixelShaderLevelDesc, 
...
void TexcubeShader::ShutdownShader()
{
...
Result TexcubeShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, 
...
void TexcubeShader::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
...
TexcubeShader::TexcubeShader(const DXLocaliser *locale) 
{
...
TexcubeShader::TexcubeShader(const TexcubeShader &other) { }
