...
Result TextureTransShader::Initialise(ID3D11Device* device, HWND hwnd)
{
	...
	Result result = InitialiseShader(device, hwnd,	"../RJ/Data/Shaders/texturetrans_sm_all.vs",
													"../RJ/Data/Shaders/texturetrans_sm_all.ps" );
...
Result TextureTransShader::InitialiseShader(ID3D11Device* device, HWND hwnd, const char* vsFilename, const char* psFilename)
{
	...
	result = D3DX11CompileFromFile(vsFilename, NULL, NULL, "TextureTransVertexShader", m_locale->DXL_VERTEX_SHADER_LEVEL_S, 
	...
	result = D3DX11CompileFromFile(psFilename, NULL, NULL, "TextureTransPixelShader", m_locale->DXL_PIXEL_SHADER_LEVEL_S, 
