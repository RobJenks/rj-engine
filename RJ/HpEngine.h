...
public:
	...
	// Returns the potential thrust that can be generated by this hardpoint
	CMPINLINE float					GetMinPossibleThrust(void) const { return (m_equipment ? ((Engine*)m_equipment)->GetMinThrust() : 0.0f); }
	CMPINLINE float					GetMaxPossibleThrust(void) const { return (m_equipment ? ((Engine*)m_equipment)->GetMaxThrust() : 0.0f); }
