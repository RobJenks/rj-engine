...
public:
	...
	CMPINLINE void CreateCuboidBound(const D3DXVECTOR3 *size) { CreateCuboidBound(size->x, size->y, size->z); }
	...
	CMPINLINE D3DXVECTOR3 GetCuboidSize(void) { return D3DXVECTOR3(m_f[0], m_f[1], m_f[2]); }
