...
Result FontShader::Initialise(ID3D11Device* device, HWND hwnd)
{
	...
	Result result = InitialiseShader(device, hwnd,	iShader::ShaderFilename("font_sm_all.vs").c_str(),
													iShader::ShaderFilename("font_sm_all.ps").c_str());
...
Result FontShader::InitialiseShader(ID3D11Device* device, HWND hwnd, const char* vsFilename, const char* psFilename)
{
	...
	result = D3DX11CompileFromFile(vsFilename, NULL, NULL, "FontVertexShader", m_locale->Locale.VertexShaderLevelDesc, 
	...
	result = D3DX11CompileFromFile(psFilename, NULL, NULL, "FontPixelShader", m_locale->Locale.PixelShaderLevelDesc, 
