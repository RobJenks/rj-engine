...
public:
	...
	enum EntityAIState
	{
		NoAI = 0,					// Entity does not have any AI control whatsoever, e.g. if it is idle or 
									// being controlled by the player
		Independent,				// Entity has full control over its actions.  It will accept higher-level orders, but
