...
const RM_SortKey RM_Instance::SORT_KEY_RENDER_FIRST = 0U;
const RM_SortKey RM_Instance::SORT_KEY_RENDER_LAST = (0U - 1U);


// Determine the sort key for an instance based upon relevant data
RM_SortKey RM_Instance::CalculateSortKey(const FXMVECTOR instance_position)
{
...
// Determine the sort key for an instance based upon relevant data
RM_SortKey RM_Instance::CalculateSortKey(float distance_sq_to_viewer)
{
